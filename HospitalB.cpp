...
int main()
{
    string hospital = "Hospital B"; // Indicates which hospital current client is
    ...
    vector<vector<string>> returnVector = processInput("HospitalB.txt");
    ...
    while (true) {
        ...
        if (printIP == 0) {
            ...
            cout << "Hospital B has UDP port " << portNum_udp << " and IP address " << ip4_udp << " for Phase 2" << endl;
            printIP++;
        }
