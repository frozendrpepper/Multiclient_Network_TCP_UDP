...
int main()
{
    string student = "Student3"; // Indicates which student current client is
    ...
    vector<string> returnVector = processInput("student3.txt");
    ...
    while (true) {
        ...
        if (printIP == 0) {
            ...
            cout << "Student3 has received the reply from the health center" << endl;
            cout << "Student3 has UDP port " << portNum_udp << " and IP address " << ip4_udp << " for Phase 2" << endl;
            printIP++;
        }
        ...
        if (finalResult.find("Reject") != string::npos) {
            cout << "Student3 has received the application result, the result is: Reject" << endl;
        } else {
            cout << "Student3 has received the application result, the result is: " << finalResult << endl;
        }
    }
