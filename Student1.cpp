...
int main()
{
    string student = "Student1"; // Indicates which student current client is
    ...
    vector<string> returnVector = processInput("student1.txt");
    ...
    while (true) {
        ...
        if (printIP == 0) {
            ...
            cout << "Student1 has received the reply from the health center" << endl;
            cout << "Student1 has UDP port " << portNum_udp << " and IP address " << ip4_udp << " for Phase 2" << endl;
            printIP++;
        }
        ...
        if (finalResult.find("Reject") != string::npos) {
            cout << "Student1 has received the application result, the result is: Reject" << endl;
        } else {
            cout << "Student1 has received the application result, the result is: " << finalResult << endl;
        }
    }
