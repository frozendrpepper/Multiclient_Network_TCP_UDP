...
int main()
{
    string student = "Student2"; // Indicates which student current client is
    ...
    vector<string> returnVector = processInput("student2.txt");
    ...
    while (true) {
        ...
        if (printIP == 0) {
            ...
            cout << "Student2 has UDP port " << portNum_udp << " and IP address " << ip4_udp << " for Phase 2" << endl;
            printIP++;
        }
        ...
        if (finalResult.find("Reject") != string::npos) {
            cout << "Student2 has received the application result, the result is: Reject" << endl;
        } else {
            cout << "Student2 has received the application result, the result is: " << finalResult << endl;
        }
    }
