...
int main()
{
    string hospital = "Hospital C"; // Indicates which hospital current client is
    ...
    vector<vector<string>> returnVector = processInput("HospitalC.txt");
    ...
    while (true) {
        ...
        if (printIP == 0) {
            ...
            cout << "Hospital C has UDP port " << portNum_udp << " and IP address " << ip4_udp << " for Phase 2" << endl;
            printIP++;
        }
